...
theta_gear=   linspace(0,-pi/180,10);                       % Roation of gear
...
%%%%%%%%%%%%%%%%%%%%% %%%%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%
O = patch('Vertices',V_tooth,'Faces',F_ch_flat,'FaceColor','yellow','EdgeColor','none');
...
zlabel("zaxis");
view(-177,38)
title('Mismatch(Graphical Output)')
